              ...
              >
                {isAudio ? (
                  ...
                  >
                    ...
                    {duration ? (
                      <Typography
                        sx={{ fontSize: '0.875rem', fontWeight: 600, color: cv.textSecondary }}
                      >
                        {duration}
                      </Typography>
                    ) : isGeneratingThumbnail ? (
                  ...
                  >
                    <Box
                      sx={{
                        ...
                        alignItems: 'center',
                        justifyContent: 'center',
                        background: cv.dialogShadow,
                        border: `1px solid ${cv.border}`,
                        backdropFilter: 'blur(8px)',
                        boxShadow: cv.shapePickerShadow,
                      }}
                    >
                      <PlayArrowRoundedIcon sx={{ fontSize: 28, color: cv.textPrimary, ml: 0.25 }} />
                    </Box>
                  </Box>
                ) : null}
              </Box>
              <Box sx={{ p: 2, background: cv.footerTint }}>
                <Typography
                  sx={{
                    fontWeight: 700,
                    fontSize: '1rem',
